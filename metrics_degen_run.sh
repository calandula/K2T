...
#python metrics_degen2.py -file='./results/guide_context/tests6/Results_Model_GPT2Finetuned8batchConcat_nBeams_4_guideContext_True_contextWeight_2.0_.txt' -n_sample=30
#python metrics_degen2.py -file='./results/guide_context/tests6/Results_Model_GPT2Finetuned8batchConcat_nBeams_4_guideContext_True_contextWeight_4.0_.txt' -n_sample=30
#python metrics_degen2.py -file='./results/guide_context/tests6/Results_Model_GPT2Finetuned8batchConcat_nBeams_4_guideContext_True_contextWeight_6.0_.txt' -n_sample=30
#python metrics_degen2.py -file='./results/guide_context/tests7/Results_Model_GPT2Finetuned8batchTarget_nBeams_4_guideContext_True_contextWeight_2.0_.txt' -n_sample=30
python metrics_degen2.py -file='./results/guide_context/tests7/Results_Model_GPT2Finetuned8batchTarget_nBeams_4_guideContext_True_contextWeight_4.0_.txt' -n_sample=30
#python metrics_degen2.py -file='./results/guide_context/tests7/Results_Model_GPT2Finetuned8batchTarget_nBeams_4_guideContext_True_contextWeight_6.0_.txt' -n_sample=30