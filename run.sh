...
# python main2.py -mode='next' -file_name='/data/guide_context/30KWFOOTBALL.txt' -results_subfolder=tests6 -weight='5.0' -top_p='0.9' -n_generated_sentences=20 -n_beams=4 -do_guarantee=True -guide_context=True -context_weight=2. -model=./transformer_models/GPT2Finetuned8batchConcat/checkpoint-645
# python main2.py -mode='next' -file_name='/data/guide_context/30KWFOOTBALL.txt' -results_subfolder=tests6 -weight='5.0' -top_p='0.9' -n_generated_sentences=20 -n_beams=4 -do_guarantee=True -guide_context=True -context_weight=4. -model=./transformer_models/GPT2Finetuned8batchConcat/checkpoint-645
# python main2.py -mode='next' -file_name='/data/guide_context/30KWFOOTBALL.txt' -results_subfolder=tests6 -weight='5.0' -top_p='0.9' -n_generated_sentences=20 -n_beams=4 -do_guarantee=True -guide_context=True -context_weight=6. -model=./transformer_models/GPT2Finetuned8batchConcat/checkpoint-645
# python main2.py -mode='next' -file_name='/data/guide_context/30KWFOOTBALL.txt' -results_subfolder=tests7 -weight='5.0' -top_p='0.9' -n_generated_sentences=20 -n_beams=4 -do_guarantee=True -guide_context=True -context_weight=2. -model=./transformer_models/GPT2Finetuned8batchTarget/checkpoint-645
# python main2.py -mode='next' -file_name='/data/guide_context/30KWFOOTBALL.txt' -results_subfolder=tests7 -weight='5.0' -top_p='0.9' -n_generated_sentences=20 -n_beams=4 -do_guarantee=True -guide_context=True -context_weight=4. -model=./transformer_models/GPT2Finetuned8batchTarget/checkpoint-645
# python main2.py -mode='next' -file_name='/data/guide_context/30KWFOOTBALL.txt' -results_subfolder=tests7 -weight='5.0' -top_p='0.9' -n_generated_sentences=20 -n_beams=4 -do_guarantee=True -guide_context=True -context_weight=6. -model=./transformer_models/GPT2Finetuned8batchTarget/checkpoint-645
